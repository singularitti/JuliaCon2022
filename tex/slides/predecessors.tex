    ...
    \begin{columns}[t]
        ...
        \begin{column}[T]{0.6\textwidth}
            \begin{tikzpicture}[baseline=(current bounding box.north)]
                \node (a) {\includegraphics[width=\textwidth]{vlab}};
...
\begin{frame}{\texttt{qha}: quasiharmonic free energy calculation for multi-configuration systems}
    \begin{columns}[t]
        ...
        \begin{column}[T]{0.5\textwidth}
            \begin{tikzpicture}[baseline=(current bounding box.north)]
                \node (a) {\includegraphics[width=\textwidth]{qha}};
    ...
    \begin{tikzpicture}[overlay, remember picture]
        \node[xshift=3.6cm,yshift=1.8cm] at (current page.south west) {\qrcode[height=1.8cm]{https://github.com/MineralsCloud/qha}};
    \end{tikzpicture}
\end{frame}
